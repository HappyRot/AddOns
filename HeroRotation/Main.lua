  ...
  HR.MainFrame:SetClampedToScreen(true);
    ...
    function HR.MainFrame:ResizeButtons (Multiplier)
      local FramesToResize = {
        ...
        {HR.ToggleIconFrame.Button[1], 30, 20},
        {HR.ToggleIconFrame.Button[2], 30, 20},
        {HR.ToggleIconFrame.Button[3], 30, 20},
		{HR.ToggleIconFrame.Button[4], 30, 20},
		{HR.ToggleIconFrame.Button[5], 30, 20},
		{HR.ToggleIconFrame.Button[6], 30, 20}
      ...
      for i = 1, 6 do
        HR.ToggleIconFrame.Button[i]:SetPoint("LEFT", HR.ToggleIconFrame, "LEFT", HR.ToggleIconFrame.Button[i]:GetWidth()*(i-3.1)+i, 0);
      end
      ...
      if SpecID then
        ...
        if HR.ON() and HR.Ready() then
          ...
          if HR.GUISettings.General.RotationDebugOutput then
            ...
            if CurrResult and CurrResult ~= PrevResult and CurrResult ~= "Slice and Dice" then
              HR.Print(CurrResult);
