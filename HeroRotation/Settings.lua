...
e.GUISettings = { General = { MainFrameStrata = "BACKGROUND", NamePlateIconAnchor = "Clickable Area", ShowWhileMounted = false, BlackBorderIcon = false, HideKeyBinds = false, SoloMode = false, HideToggleIcons = false, NotEnoughManaEnabled = false, RotationDebugOutput = false, OpenerReset = 0, SetAlpha = 1, TickRate = 0, HoldPotforBL = false, SilentMode = false, MiniMap = false, AdaptivePerformance = true, TargetFrames = 60 }, Scaling = { ScaleUI = 1, ScaleButtons = 1, ScaleHotkey = 1 }, APL = {  } }
function e.GUI.CorePanelSettingsInit()
    local o = o(e.GUI, "HeroRotation", "PanelFrame", e.GUISettings, HeroRotationDB.GUISettings)
    local e = a(o, "General")
    local a = a(o, "Scaling")
    ...
    t("CheckButton", e, "General.ShowWhileMounted", "Show While Mounted", "Enable if you want the HeroRotation icon to show while mounted.")
