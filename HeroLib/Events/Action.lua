...
HL:RegisterForEvent(
  ...
  "ZONE_CHANGED_NEW_AREA", "PLAYER_SPECIALIZATION_CHANGED", "PLAYER_TALENT_UPDATE", "UPDATE_BINDINGS", "LEARNED_SPELL_IN_TAB", "SPELL_UPDATE_ICON", "ACTIONBAR_SLOT_CHANGED"
)
