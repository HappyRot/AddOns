...
e("Slider", a, "APL.Hunter.BeastMastery.SurvivaloftheFitestHP", { 0, 100, 1 }, "Survival of the Fitest HP", "Set the Survival of the Fitest HP threshold. Set to 0 to disable.")
