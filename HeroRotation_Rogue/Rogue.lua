...
j.Rogue.Outlaw = m(j.Rogue.Commons,
    { AdrenalineRush = j(13750), Ambush = j(8676), BetweentheEyes = j(315341), BladeFlurry = j(13877), Dispatch = j(2098),
        ...
        KillingSpree = j(51690), LoadedDiceBuff = j(256171), MarkedforDeath = j(137619), PreyontheWeak = j(131511),
        PreyontheWeakDebuff = j(255909), QuickDraw = j(196938), SwiftSlasher = j(381988), TakeEmBySurpriseBuff = j(385907),
        Weaponmaster = j(200733), Gouge = j(1776), Broadside = j(193356), BuriedTreasure = j(199600),
        GrandMelee = j(193358), RuthlessPrecision = j(193357), SkullandCrossbones = j(199603), TrueBearing = j(193359) })
