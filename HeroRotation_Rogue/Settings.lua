...
e("Dropdown", o, "APL.Rogue.Assassination.LethalPoison1", { "Instant Poison", "Wound Poison", "Deadly Poison", "Amplifying Poison", "None" }, "Lethal Poison", "Lethal Poison to apply")
e("Dropdown", o, "APL.Rogue.Assassination.NonLethalPoison1", { "Numbing Poison", "Crippling Poison", "Atrophic Poison", "None" }, "Non-Lethal Poison", "Non-Lethal Poison to apply (Drago-Tempered Blades Talent)")
e("Slider", o, "APL.Rogue.Assassination.EnvenomDMGOffset", { 1, 5, .25 }, "Envenom DMG Offset", "Set the Envenom DMG Offset.")
e("Slider", o, "APL.Rogue.Assassination.MutilateDMGOffset", { 1, 5, .25 }, "Mutilate DMG Offset", "Set the Mutilate DMG Offset.")
e("CheckButton", o, "APL.Rogue.Assassination.AlwaysSuggestGarrote", "Always Suggest Garrote", "Don't prevent Garrote suggestions when using Subterfuge and Vanish is ready. These should ideally be synced, but can be useful if holding Vanish for specific fights.")
e("Dropdown", o, "APL.Rogue.Assassination.LethalPoison2", { "Instant Poison", "Wound Poison", "Deadly Poison", "Amplifying Poison", "None" }, "Lethal Poison #2", "Lethal Poison 2 to apply")
e("Dropdown", o, "APL.Rogue.Assassination.NonLethalPoison2", { "Numbing Poison", "Crippling Poison", "Atrophic Poison", "None" }, "Non-Lethal Poison #2", "Non-Lethal Poison to apply  (Drago-Tempered Blades Talent)")
o["APL.Rogue.Assassination.LethalPoison2"]:SetPoint("TOPLEFT", 180, -30)
n(o, "APL.Rogue.Assassination")
e("Dropdown", i, "APL.Rogue.Outlaw.TargetSwap", { "Mouseover", "AutoSwap" }, "DoT Spread Method", "Choose Which Method to use to spread DoTs")
e("Dropdown", i, "APL.Rogue.Outlaw.RolltheBonesLogic", { "SimC", "1+ Buff", "Broadside", "Buried Treasure", "Grand Melee", "Skull and Crossbones", "Ruthless Precision", "True Bearing" }, "Roll the Bones Logic", "Define the Roll the Bones logic to follow.\n(SimC highly recommended!)")
e("Slider", i, "APL.Rogue.Outlaw.BRRange", { 5, 20, 1 }, "Blade Rush Range", "Set the Range to use Blade Rush")
e("Slider", i, "APL.Rogue.Outlaw.RolltheBonesLeechKeepHP", { 1, 100, 1 }, "Keep Leech HP Threshold", "Set the HP threshold for keeping the leech buff instead of rerolling normally (working only if Solo Mode is enabled and does not work in dungeons.)")
e("Slider", i, "APL.Rogue.Outlaw.RolltheBonesLeechRerollHP", { 1, 100, 1 }, "Reroll For Leech HP Threshold", "Set the HP threshold to actively re-roll for the leech buff (working only if Solo Mode is enabled and does not work in dungeons.)")
n(i, "APL.Rogue.Outlaw")
