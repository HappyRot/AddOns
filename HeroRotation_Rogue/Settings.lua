...
e("CheckButton", o, "APL.Rogue.Outlaw.DumpSpikes", "Dump bonespike charges at end of boss fight", "Useful in raid, perhaps less so in dungeons.")
e("CheckButton", o, "APL.Rogue.Outlaw.CastCancelFC", "Cancel-Cast Fleshcraft", "Cancel-Cast Fleshcraft to keep the Volatile Solvent buff.")
i(o, "APL.Rogue.Outlaw")
...
e("Dropdown", t, "APL.Rogue.Subtlety.BurnShadowDance", { "Always", "On Bosses", "On Bosses not in Dungeons" }, "Burn Shadow Dance before Death", "Use remaining Shadow Dance charges when the target is about to die.")
