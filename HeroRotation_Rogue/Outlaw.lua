...
local function aF() if n() and R.AdrenalineRush:IsCastable() and not g:BuffUp(R.AdrenalineRush) and
    ...
    .BladeRush:IsCastable() and h:IsSpellInRange(R.SinisterStrike) and ay() and not g:DebuffUp(R.Dreadblades) and
    ...
    :IsSpellInRange(R.SinisterStrike) and n() then if Q.Commons.VanishOffensive and R.Shadowmeld:IsCastable() and
